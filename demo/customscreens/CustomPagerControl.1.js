    ...
    CustomPagerControl.prototype.initialize=function(){
        ...
        if(this.level.getNestDepth()==1){
                html+=(this.grid.enableDrillDown?"<span  id='"+gridId+"btnCollapseOne' class='pagerDiv  iconCell'><img tabindex='0' src='" + this.grid.getThemeToolbarIconFolder() + "/collapseOne.png' class='imageButtonExpandUp' alt='"+flxConstants.PGR_BTN_EXP_ONE_UP_TOOLTIP+"' title='"+flxConstants.PGR_BTN_EXP_ONE_UP_TOOLTIP+"'></span>":"")+
                    ...
                    "<span  id='"+gridId+"btnIncGrid' class='pagerDiv  iconCell' style='width: 16px;text-align: center'><span style='display: inline-block; color:#ffa000; width: 100%; height: 100%'>&#x254B;</span></span>"+
                    "<span  id='"+gridId+"btnDecGrid' class='pagerDiv  iconCell' style='width: 16px;text-align: center'><span style='display: inline-block; color:#ffa000; width: 100%; height: 100%'>&#x257E;</span></span>"+
                    "<span  id='"+gridId+"btnRefGrid' class='pagerDiv  iconCell' style='width: 16px;text-align: center'><span style='display: inline-block; color:#ffa000; width: 100%; height: 100%'>&#x23F0;</span></span>"+
